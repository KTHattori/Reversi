...
//         /// 石が置かれていない
//         /// </summary>
//         public static readonly int NONE_SIDE = 0;
//         /// <summary>
//         /// 黒石側（先手）
//         /// </summary>
//         public static readonly int BLACK_SIDE = 1;
//         /// <summary>
//         /// 白石側（後手）
//         /// </summary>
//         public static readonly int WHITE_SIDE = -1;
//         /// <summary>
//         /// ボードの1辺サイズ
//         /// </summary>
...
//         {
//             get { return ((_currentTurn % 2) == 0) ? BLACK_SIDE : WHITE_SIDE;}
//         }
...
//         {
//             ulong mask = 1ul << (y * 8 + x);

//             if ((_blackBoard & mask) != 0) return BLACK_SIDE;
//             if ((_whiteBoard & mask) != 0) return WHITE_SIDE;
//             return NONE_SIDE;
//         }
...
//         public void SetStoneAt(int x, int y, int side)
//         {
//             ulong mask = 1ul << (y * 8 + x);
